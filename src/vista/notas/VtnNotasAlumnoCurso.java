...
public class VtnNotasAlumnoCurso extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        if (tblNotas.getColumnModel().getColumnCount() > 0) {
            ...
            tblNotas.getColumnModel().getColumn(2).setMinWidth(160);
            tblNotas.getColumnModel().getColumn(2).setPreferredWidth(160);
            tblNotas.getColumnModel().getColumn(2).setMaxWidth(160);
            tblNotas.getColumnModel().getColumn(3).setMinWidth(155);
            tblNotas.getColumnModel().getColumn(3).setPreferredWidth(155);
            tblNotas.getColumnModel().getColumn(3).setMaxWidth(155);
