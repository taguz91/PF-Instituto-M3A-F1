...
public class EvaluacionSilaboBD extends EvaluacionSilaboMD {
    ...
    public void insertar(EvaluacionSilaboMD e, int is, int im) {
        ...
        try {
            PreparedStatement st = conexion.getCon().prepareStatement("INSERT INTO public.\"EvaluacionSilabo\"(\n"
                    ...
                    + "	VALUES ( (SELECT MAX(id_unidad) FROM \"UnidadSilabo\",\"Silabo\" WHERE \"UnidadSilabo\".id_silabo="+is+"AND \"Silabo\".id_materia="+im+" ), ?, ?, ?, ?, ?, ?)");
