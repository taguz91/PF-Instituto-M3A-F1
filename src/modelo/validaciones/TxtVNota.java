 ...
 * @author Johnny
 */
public class TxtVNota extends KeyAdapter {

    private final JTextField txt;
    private final JLabel lbl;
    private String ingreso;

    public TxtVNota(JTextField txt) {
        this.txt = txt;
        this.lbl = null;
    }

    public TxtVNota(JTextField txt, JLabel lbl) {
        this.txt = txt;
        this.lbl = lbl;
    }
