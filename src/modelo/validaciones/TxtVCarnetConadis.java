 ...
 * @author Johnny
 */
public class TxtVCarnetConadis extends KeyAdapter {
    
    private final JTextField txt;
    private final JLabel lbl;
    private String ingreso;

    public TxtVCarnetConadis(JTextField txt) {
        this.txt = txt;
        this.lbl = null;
    }

    public TxtVCarnetConadis(JTextField txt, JLabel lbl) {
        this.txt = txt;
        this.lbl = lbl;
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getKeyCode() != 10 && e.getKeyCode() != 127 && ingreso.length() > 0) {
            ...
            if (!Validar.esCarnetConadis(ingreso)) {
