...
public class TxtVCorreo extends KeyAdapter{
    
    private final JTextField txt;
    private final JLabel lbl;
    private String ingreso;

    public TxtVCorreo(JTextField txt) {
        this.txt = txt;
        this.lbl = null;
    }
    

    public TxtVCorreo(JTextField txt, JLabel lbl) {
        this.txt = txt;
        this.lbl = lbl;
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if(ingreso.equals("")){
           ...
           if (e.getKeyCode() != 10 && e.getKeyCode() != 127 && ingreso.length() > 0) {
            ...
            if (!Validar.esCorreo(ingreso) && !Validar.esCorreoAr(ingreso)) {
