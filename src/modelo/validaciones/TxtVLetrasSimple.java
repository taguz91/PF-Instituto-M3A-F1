 ...
 * @author Johnny
 */
public class TxtVLetrasSimple extends KeyAdapter {

    private final JTextField txt;
    private final JLabel lbl;
    private String ingreso;

    public TxtVLetrasSimple(JTextField txt) {
        this.txt = txt;
        this.lbl = null;
    }

    public TxtVLetrasSimple(JTextField txt, JLabel lbl) {
        this.txt = txt;
        this.lbl = lbl;
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (ingreso.equals("")) {
            ...
            if (e.getKeyCode() != 10 && e.getKeyCode() != 127 && ingreso.length() > 0) {
                ...
                if (!Validar.esLetrasSimple(ingreso)) {
                    txt.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 0, 0)));
                    if (lbl != null) {
                        lbl.setVisible(true);
                        lbl.setText("No se permite caracteres especiales ni espacios.");
                    }
                } else {
                    txt.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
                    if (lbl != null) {
