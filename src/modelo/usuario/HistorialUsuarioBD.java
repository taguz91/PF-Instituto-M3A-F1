...
public class HistorialUsuarioBD extends HistorialUsuarioMD {
    ...
    /**
     * Consultamos el historial de usuarios de una tabla una accion y entre fechas
     * @param username
     * @param tabla
     * @param accion
     * @param fecha
    ...
    /**
     * Cargamos el historial de un usuario en una tabla con una accion y entre fechas.
     * @param username
     * @param tabla
     * @param accion
     * @param fechaIni
