...
public class AvanzeUnidadesBDA extends AvanzeUnidadesMDA {
    ...
    public static List<AvanzeUnidadesMDA> consultarUnidadAvanze(ConexionBD conexion, int id_curso, int id_segui) {

        List<AvanzeUnidadesMDA> unidades = new ArrayList<>();

        try {

            PreparedStatement st = conexion.getCon().prepareStatement("SELECT us.id_unidad,us.titulo_unidad,us.contenidos_unidad,uss.id_seguimientosilabo,uss.cumplimiento_porcentaje,\n"
