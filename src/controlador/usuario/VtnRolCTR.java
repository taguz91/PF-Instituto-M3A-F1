...
public class VtnRolCTR {
    ...
    private final UsuarioMD Permisos;
    
    private List<RolMD> listaRoles;
    
    private static DefaultTableModel modelT;
    
    public VtnRolCTR(VtnPrincipal desktop, VtnRol vista, RolBD modelo, UsuarioMD Permisos) {
    ...
    private void InitPermisos() {
        ...
        for (AccesosMD permiso : Permisos.getPermisos()) {
