...
//        VtnPrincipalCTR ventanaPrincipal = new VtnPrincipalCTR(new VtnPrincipal(), new RolBD(), new UsuarioBD(), new ConectarDB("postgres", "NuEvOsErVeR1997", "LoginGenerico"), icono, ista);
